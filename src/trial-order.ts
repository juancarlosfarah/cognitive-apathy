...
import { State, TrialOrdersType } from "./types";
 ...
 */
export const userTrialOrder = (jsPsych: JsPsych, state: State) => {
 ...
 */
export const randomTrialOrder = (jsPsych: JsPsych, state: State) => ({
