...
export const NUM_VALIDATION_TRIALS = 4;
export const NUM_EXTRA_VALIDATION_TRIALS = 3;
export const NUM_DEMO_TRIALS = 1;
export const MINIMUM_DEMO_TAPS = 4;
export const FAILED_MINIMUM_DEMO_TAPS_DURATION = 1000;
export const NUM_TRIALS = 63;
export const TRIAL_DURATION = 5000;
...
export const TUTORIAL_MESSAGE_1 = i18n.t('TUTORIAL_MESSAGE_1');
...
export const COUNTDOWN_DIRECTIONS = i18n.t('COUNTDOWN_DIRECTIONS', {
    KEY_TO_PRESS: KEY_TO_PRESS.toUpperCase(),
});
...
export const LIKERT_SURVEY_1_QUESTIONS = {
    ...
    QUESTION_3: i18n.t('LIKERT_SURVEY_1_QUESTIONS.QUESTION_3')
};
